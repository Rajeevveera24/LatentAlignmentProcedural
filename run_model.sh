...
python main_copy.py -i 1 -n 100 -m test -s test -l True -c 0 -p save/baseline_one/ -f outputs/log.txt -a 8 -e 2 -o one -r 0.001 -x True

# python main_copy.py -i 5 -n 1500 -m train -s False -c 0 -p save/baseline_one/ -f outputs/log.txt -a 8 -e 2 -o one -r 0.001 -x True
# python main_copy.py -i 5 -n 1500 -m train -s False -c 0 -p save/baseline_all/ -f outputs/log.txt -a 8 -e 2 -o all -r 0.001 -x True
